if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("Szordhex")
          if ui then
              ui:Destroy()
          end
      end
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("Szordhex Hub",Enum.KeyCode.RightControl)
  ...
  function UpdateFruits()
      ...
      local df = sxhub:AddTab("Devil Fruit","7044284832")
  ...
  set:AddLabel("Setting")
      set:AddButton("Credit By Stephen aka Szordrin",function()
  end)
      set:AddButton("Copy link Szordhex Discord ",function()
      setclipboard("https://discord.gg/mQSS4aRWgU")
  end)
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("Szordhex - King Legacy",Enum.KeyCode.RightControl)
      --
